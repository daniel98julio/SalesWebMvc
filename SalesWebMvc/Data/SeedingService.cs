...
namespace SalesWebMvc.Data {
    public class SeedingService {
        ...
        public void Seed() {
            ...
            Seller s1 = new Seller(1, "Daniel", "Daniel@gmail.com", new DateTime(1998, 7, 28), 1000.0, d1);
            Seller s2 = new Seller(2, "Sabrina", "Sabrina@gmail.com", new DateTime(2002, 6, 6), 1500.0, d2);
            Seller s3 = new Seller(3, "Pedro", "Pedro@gmail.com", new DateTime(1997, 4, 1), 2000.0, d3);
            Seller s4 = new Seller(4, "Caio", "Caio@gmail.com", new DateTime(1999, 5, 25), 2500.0, d4);
            Seller s5 = new Seller(5, "Victor", "Victor@gmail.com", new DateTime(1996, 4, 21), 3000.0, d1);
            Seller s6 = new Seller(6, "Caroline", "Caroline@gmail.com", new DateTime(1999, 1, 1), 3500.0, d2);
            Seller s7 = new Seller(7, "Daiane", "Daiane@gmail.com", new DateTime(1998, 4, 14), 4000.0, d3);
            Seller s8 = new Seller(8, "João", "João@gmail.com", new DateTime(2000, 10, 12), 4500.0, d4);
            Seller s9 = new Seller(9, "Marcos", "Marcos@gmail.com", new DateTime(1992, 9, 7), 5000.0, d1);
            Seller s10 = new Seller(10, "Silvana", "Silvana@gmail.com", new DateTime(1971, 6, 23), 5500.0, d2);
            Seller s11 = new Seller(11, "Roberto", "Roberto@gmail.com", new DateTime(1965, 12, 13), 6000.0, d3);
            Seller s12 = new Seller(12, "Mariana", "Mariana@gmail.com", new DateTime(2001, 8, 12), 6500.0, d4);
            ...
            _context.Seller.AddRange(s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12);
